...
export function collapse(a: CollapseArgs = {}): string {
  ...
  return `<details class="${cx("collapse ita-collapse", a.bordered && "ita-collapse-bordered")}"${a.name ? ` name="${a.name}"` : ""}${a.open ? " open" : ""}>
...
export const doc: ComponentDoc = {
  ...
  classes: ["ita-collapse", "ita-collapse-bordered", "ita-collapse-link", "ita-btn", "ita-chevron"],
  daisy: ["collapse", "collapse-title", "collapse-content"],
  cssOnly:
